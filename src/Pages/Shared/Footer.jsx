        ...
        <footer className="mt-6 dark:bg-gray-800 w-full py-8">
            <div className="max-w-screen-xl px-4 mx-auto">
                ...
                <ul className="flex flex-wrap justify-between max-w-screen-md mx-auto text-lg font-light">
                    ...
                    <li className="my-2">
                        <Link to="https://github.com" className="text-gray-400 hover:text-gray-800 dark:text-gray-300 dark:hover:text-white transition-colors duration-200" href="#">
                            Github
                        </Link>
                    </li>
                    <li className="my-2">
                        <Link to="https://www.linkedin.com" className="text-gray-400 hover:text-gray-800 dark:text-gray-300 dark:hover:text-white transition-colors duration-200" href="#">
                            LinkedIn
                        </Link>
                    </li>
                </ul>
                ...
                <div className="text-center pt-10 sm:pt-12 font-light text-white flex flex-col gap-3 items-center justify-center">
                    <h3>CONTACT</h3>
                    <p>tamimtarik15@gmail.com</p>
                    <p>+880-01612677177</p>
                </div>
                <div className="text-center text-gray-500 dark:text-gray-200 pt-10 sm:pt-12 font-light flex items-center justify-center">
                    <p>&copy; 2024 tarekulislam</p>
                </div>
            </div>
        </footer>
    );
