        ...
        <div className="navbar text-white mb-6 bg-[#3c4858]">
            <div className="navbar-start">
                <div className="dropdown z-10">
                    ...
                    <ul tabIndex={0} className="menu text-[#1F2937] menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                        {navLinks}
                    </ul>
                </div>
                ...
                </div>
                {
                    user ? <div className="dropdown dropdown-end">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                            {
                                user && <Link className="btn" to="/login"><button onClick={handleLogout}>Log Out</button></Link>
                            }
                        </ul>
